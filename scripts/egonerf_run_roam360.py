...
# synthetic360
dataset_dir = "../data/Roam360"
scene_list_path = "./egonerf_scene_list_roam360.txt"
exp_loops = [10]
test_iters = [8000, 32000]

training_cfg_path = "../cfg/lonlat/egonerf_lonlat_roam360.yaml"
result_root = "../results/lonlat/EgoNeRF/roam360"
