...
for scene in scene_list:
    ...
    points_ply_file = os.path.join(colmap_dir, "points3D.ply")
    ...
    if os.path.exists(points_ply_file):
        print("Use exist ply file")
        shutil.copy2(points_ply_file, ply_output_path)
    else:
